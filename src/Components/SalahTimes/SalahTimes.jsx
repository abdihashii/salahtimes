...
export const SalahTimes = () => {
  const { isLoading, prayerTimes } = useContext(SalahTimesContext);
      ...
      {isLoading ? (
        ...
        <div className="columns mt-5">
          <div className="column">
            <p className="title is-4 is-uppercase has-text-weight-bold">Fajr</p>
          ...
          <div className="column">
            <p className="title is-4 is-uppercase has-text-weight-bold">Asr</p>
          ...
          <div className="column">
            <p className="title is-4 is-uppercase has-text-weight-bold">Isha</p>
