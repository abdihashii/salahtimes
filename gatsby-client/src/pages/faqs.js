  ...
  return (
    <Layout>
      <main className="pb-16 text-black">
        <h1 className="mx-auto mt-10 mb-22px w-10/12 text-center text-32px font-semibold leading-39px text-green-dark lg:mt-6 lg:mb-30px lg:w-5/12 lg:pt-16 lg:text-6xl">
