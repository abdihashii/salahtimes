		...
		<footer className="mx-auto flex w-full flex-col border-t-4 border-green-secondary pt-12 tracking-[0.011em]">
			<section className="lg:mx-auto lg:flex lg:w-8/12 lg:flex-row lg:gap-16 xl:w-7/12">
				...
				<div className="gap-8 lg:flex lg:w-6/12 lg:flex-col">
					...
					<Link
						href="/"
						className="mb-8 flex flex-row items-center justify-center lg:mb-0 lg:justify-start"
					>
					...
					{/* footer one-liner */}
					<div className="mx-auto mb-12 w-10/12 justify-center text-center text-base text-[#646464] dark:text-white lg:!ml-0 lg:w-10/12 lg:text-left lg:leading-8">
						<p>
